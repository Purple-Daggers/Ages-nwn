...
const string GS_T_16777216 = "<cnnn>GIGASCHATTEN <c˛ø >NWN Engine";
...
const string GS_T_16777433 = "<c˛((>The item %1 has been destroyed.";
...
const string GS_T_16777462 = "<cfÃ˛>You try to assess <cô˛˛>%1<cfÃ˛> (Accuracy: %2):";
const string GS_T_16777463 = "irresolute";
const string GS_T_16777464 = "<c˛  >extremely low";
const string GS_T_16777465 = "<c˛V >low";
const string GS_T_16777466 = "<c˛£ >below-average";
const string GS_T_16777467 = "<c˛Ë >average";
const string GS_T_16777468 = "<cË˛ >above-average";
const string GS_T_16777469 = "<c£˛ >high";
const string GS_T_16777470 = "<cV˛ >extremely high";
...
const string GS_T_16777476 = "<c˛Î¶>%1: %2 gold";
...
const string GS_T_16777499 = "<c˛Î¶>}--{==== Next challenge ====>\n<c‚€¬>%1 versus %2";
const string GS_T_16777500 = "<c˛((>The contest has begun.";
const string GS_T_16777501 = "<c˛Î¶>}--{==== Current rankings ====>";
const string GS_T_16777502 = "%1. %2\n<c™’˛>    %3<c‚€¬> victories / <c˛((>%4<c‚€¬> defeats";
const string GS_T_16777503 = "<c‚€¬>Join the contests - sign in now!";
...
const string GS_T_16777515 = "<c˛Î¶>~^~ Ongoing investigations ~^~";
const string GS_T_16777516 = "\n<c‚€¬>%1. <c˛˛˛>%2\n    <c˛˛˛>%3 <c‚€¬>versus <c˛˛˛>%4";
const string GS_T_16777517 = "\n    <c‚€¬>Severity: <c˛˛˛>%1\n    <c‚€¬>Case number: <c˛˛˛>%2\n    <c‚€¬>Testimonies: <c˛˛˛>%3\n    <c‚€¬>Estimation: %4";
const string GS_T_16777518 = "<cV˛ >innocent";
const string GS_T_16777519 = "<c˛Ë >undetermined";
const string GS_T_16777520 = "<c˛  >guilty";
const string GS_T_16777521 = "\n    <c(î˛>Time: %1 month(s), %2 day(s), %3 hour(s), %4 minute(s)";
const string GS_T_16777522 = "<c˛Î¶>~^~ Convictions ~^~";
...
const string GS_T_16777554 = "Prasien√©";
...
const string GS_T_16777563 = "Bh√≥ldic";
...
const string GS_T_16777579 = "M√°losari";
