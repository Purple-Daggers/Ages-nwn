...
//    MK_DEBUG_TRACE("ColorMode = "+IntToString(nColorMode)
//        +", Action = "+IntToString(nAction));
    ...
    case nMainMenu:
        ...
        MK_GenericDialog_SetCondition(GetLocalInt(oPC, g_varEditorOK), TRUE);
        MK_GenericDialog_SetCondition(GetLocalInt(oPC, g_varEditorCancel), TRUE);
...
void CreateDisplay(object oPC, string sText, int nCursor, int nBlock)
{
/*    MK_DEBUG_TRACE("CreateDisplay(1): "+
        "sText="+sText+", "+
...
/*    MK_DEBUG_TRACE("CreateDisplay(2): "+
        "sLeft="+sLeft+", "+
        "sMid="+sMid+", "+
        "sRight="+sRight);
*/
...
//        MK_DEBUG_TRACE("Delta="+sOutput+" ("+FloatToString(lastAction.fTimeStamp)+") ,"
